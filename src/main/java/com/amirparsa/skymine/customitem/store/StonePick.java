...
public class StonePick extends CustomItem {
    public StonePick(){
        super("ROCK_PICK", "Rock Pick", Rarity.COMMON, Type.PICK, new CustomEnchantment[]{new CustomEnchantment(Enchantment.DIG_SPEED, 1, 1, Rarity.COMMON)}, Material.STONE_PICKAXE);
    }
}
