...
public class WoodenBoots extends CustomItem {
    public WoodenBoots(){
        super("WOOD_BOOTS", "Wood Boots", Rarity.COMMON, Type.ARMOR, new CustomEnchantment[]{new CustomEnchantment(Enchantment.PROTECTION_ENVIRONMENTAL, 1, 1, Rarity.COMMON)}, Material.LEATHER_BOOTS);
    }
}
